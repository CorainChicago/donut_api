...
RSpec.describe DonutsController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      donut = Donut.create! valid_attributes
      get :edit, params: {id: donut.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Donut" do
        expect {
          post :create, params: {donut: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {donut: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested donut" do
        donut = Donut.create! valid_attributes
        put :update, params: {id: donut.to_param, donut: new_attributes}, session: valid_session
        donut.reload
      ...
      it "redirects to the donut" do
        donut = Donut.create! valid_attributes
        put :update, params: {id: donut.to_param, donut: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        donut = Donut.create! valid_attributes
        put :update, params: {id: donut.to_param, donut: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested donut" do
      donut = Donut.create! valid_attributes
      expect {
        delete :destroy, params: {id: donut.to_param}, session: valid_session
      }.to change(Donut, :count).by(-1)
    end
